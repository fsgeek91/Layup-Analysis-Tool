...
%
%   To use the routine for a strength calculation with Layup Analysis Tool,
%   specify the following in the layup definition file:
%
%     OUTPUT_STRENGTH = {@<criterion-name>, ..};
%
