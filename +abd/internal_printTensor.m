...
if isempty(E_therm_xy) == false &&...
    ...
    fprintf(fid, ['\nStress-free strain due to thermal process at user',...
        '-selected locations:\n']);
    fprintf(fid, ['PLY  SECTION POINT                 E_Therm_xx    E_',...
        'Therm_yy    E_Therm_xy    E_Therm_11    E_Therm_22    E_Therm',...
        '_12    \n']);
    ...
    if OUTPUT_ENVELOPE == true
        ...
        fprintf(fid, '%-5s%-30s%-14g%-14g%-14g%-14g%-14g%-14g\n',...
            'ALL', envelopeString, E_therm_xy_envelope_11,...
        ...
        for i = 1.0:nPlies
            ...
            if isempty(currentOutputPoints) == true
                ...
                for sp = 1.0:length(currentOutputPoints)
                    ...
                    fprintf(fid, '%-5.0f%-30s%-14g%-14g%-14g%-14g%-14g%-14g\n',...
                        i, thicknessFraction, E_therm_xy_i(1.0, sp),...
                        E_therm_xy_i(2.0, sp), E_therm_xy_i(3.0, sp),...
...
if isempty(E_moist_xy) == false &&...
    ...
    fprintf(fid, ['PLY  SECTION POINT                 E_Moist_xx    E_',...
        'Moist_yy    E_Moist_xy    E_Moist_11    E_Moist_22    E_Moist',...
        '_12    \n']);
        ...
        for i = 1.0:nPlies
            ...
            if isempty(currentOutputPoints) == true
                ...
                for sp = 1.0:length(currentOutputPoints)
                    ...
                    fprintf(fid, '%-5.0f%-30s%-14g%-14g%-14g%-14g%-14g%-14g\n',...
                        i, thicknessFraction, E_moist_xy_i(1.0, sp),...
                        E_moist_xy_i(2.0, sp), E_moist_xy_i(3.0, sp),...
