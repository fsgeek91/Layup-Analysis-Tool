        ...
        function [error, output] = getSettings(OUTPUT_OPTIMISED,...
            ...
            if (all(cellfun(@isempty, OUTPUT_OPTIMISED)) == true) ||...
                ...
                fprintf(['[LAYUP-ANALYSIS-TOOL ERROR] The setting OUTP',...
                    'UT_OPTIMISED requires four\narguments: {''<criter',...
                    'ion>'', ''<parameter>'', ''<fun>'', theta}\n']);
            ...
            elseif ischar(argument) == false
                ...
                fprintf(['[LAYUP-ANALYSIS-TOOL ERROR] OUTPUT_OPTIMISED',...
                    '(1) must be a string\n']);
            ...
            elseif ischar(argument) == true
                if (strcmpi(argument, 'mstrs') == false) &&...
                    ...
                    if (strcmpi(argument, 'hsnftcrt') == true) ||...
                        ...
                        fprintf(['[LAYUP-ANALYSIS-TOOL ERROR] Paramete',...
                            'r ''HSNFTCRT'', ''HSNFCCRT'',\n''HSNMTCRT',...
                            ''' or ''HSNMCCRT'' is used for OUTPUT_OPT',...
                            'IMISED(1). Sspecify\n''HASHIN'' instead\n']);
                    else
                        fprintf(['[LAYUP-ANALYSIS-TOOL ERROR] OUTPUT_O',...
                            'PTIMISED(1) must be one of the\nfollowing',...
                            ' parameters: MSTRS, TSAIH, TSAIW, AZZIT, ',...
                            'MSTRN or HASHIN\n']);
                    end
                ...
                elseif (noFailStress == true) &&...
                    ...
                    fprintf(['[LAYUP-ANALYSIS-TOOL ERROR] Requested a ',...
                        'stress-based criterion for\noptimisation, but',...
                        ' FAIL_STRESS properties are not available\n']);
                ...
                elseif (noFailStrain == true) &&...
                    ...
                    % Insufficient material data
                    fprintf(['[LAYUP-ANALYSIS-TOOL ERROR] Requested a ',...
                        'strain-based criterion for\noptimisation, but',...
                        ' FAIL_STRAIN properties are not available\n']);
                ...
                elseif (noHashin == true) && (OUTPUT_STRENGTH == true) &&...
                    ...
                    % Insufficient material data
                    fprintf(['[LAYUP-ANALYSIS-TOOL ERROR] Requested a ',...
                        'Hashin criterion for optimisation,\nbut HASHI',...
                        'N properties are not available\n']);
            ...
            if (argument <= 0.0) || (argument > 90.0)
                fprintf(['[LAYUP-ANALYSIS-TOOL ERROR] Invalid value of',...
                    ' OUTPUT_OPTIMISED(4). The\nangular step size must',...
                    ' be in the range {0 < theta <= 90}\n']);
