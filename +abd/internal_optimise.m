...
%%
    ...
    methods(Static = true, Access = public)
        ...
        function [BEST_SEQUENCE, CRITERION_BUFFER, MIN_CRITERION] =...
            ...
            % Get the Hashin damage initiation criterion (if necessary)
            if strcmpi(failureCriterion, 'hsnftcrt') == true ||...
                    strcmpi(failureCriterion, 'hsnfccrt') == true ||...
                    strcmpi(failureCriterion, 'hsnmtcrt') == true ||...
                    strcmpi(failureCriterion, 'hsnmccrt') == true
                % Get the Hashin sub-criterion
                switch lower(failureCriterion)
                    case 'hsnftcrt'
                        failureSubCriterion = 1.0;
                    case 'hsnfccrt'
                        failureSubCriterion = 2.0;
                    case 'hsnmtcrt'
                        failureSubCriterion = 3.0;
                    case 'hsnmccrt'
                        failureSubCriterion = 4.0;
                    otherwise
                end

                % Set the Hashin criterion
            ...
            parfor i = 1.0:nPermutations
                ...
                switch lower(failureCriterion)
                    ...
                    case 'hashin'
                        ...
                        HASHIN_ALL = [CRITERION_1; CRITERION_2;...
                            CRITERION_3; CRITERION_4];

                        % Extract the relevant criterion
                        CRITERION = HASHIN_ALL(failureSubCriterion, :);
                    otherwise
        ...
        function [error, output] = getSettings(OUTPUT_OPTIMISED,...
                noFailStress, noFailStrain, noHashin)
            % Initialise output
            error = false;
            output = cell(1.0, 4.0);
            ...
            elseif ischar(argument) == true
                if (strcmpi(argument, 'mstrs') == false) &&...
                    ...
                    (strcmpi(argument, 'hsnftcrt') == false) &&...
                    (strcmpi(argument, 'hsnfccrt') == false) &&...
                    (strcmpi(argument, 'hsnmtcrt') == false) &&...
                    (strcmpi(argument, 'hsnmccrt') == false)
                    % Unregognised parameter
                    if strcmpi(argument, 'hashin') == true
                        fprintf(['[ABD ERROR] Parameter ''HASHIN'' is ',...
                            'used for OUTPUT_OPTIMISED(1). One of\nthe',...
                            ' following Hashin failure modes must be s',...
                            'pecified: HSNFTCRT, HSNFCCRT,\nHSNMTCRT o',...
                            'r HSNMCCRT\n']);
                    else
                ...
                elseif (noFailStrain == true) && (strcmpi(argument, 'mstrn') == true)
                    ...
                    error = true;
                    return
                elseif (noHashin == true) &&...
                        (strcmpi(argument, 'hsnftcrt') == true ||...
